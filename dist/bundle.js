...
/***/ "./src/actions/customizeActions.js":
/*!*****************************************!*\
  !*** ./src/actions/customizeActions.js ***!
  \*****************************************/
/*! no static exports found */
...
var customizeActions = function customizeActions(dispatch) {
  return {
    fetchConstituents: function fetchConstituents() {
      dispatch({ type: _actionTypes2.default.constituent.CONSTITUENT_FETCH });
      var bucketList = [];
      var categories = [];

      _data2.default.map(function (portfolio) {
        var constituents = portfolio.constituents;

        constituents.map(function (constituent) {
          var weight = constituent.weight,
              _constituent$instrume = constituent.instrument,
              id = _constituent$instrume.id,
              name = _constituent$instrume.name,
              type = _constituent$instrume.type;
      ...
      dispatch({ type: _actionTypes2.default.constituent.CONSTITUENT_FETCH_SUCCESS, payload: { bucketList: bucketList, categories: categories } });
    },

    weightChanged: function weightChanged(id, weight) {
      dispatch({ type: _actionTypes2.default.constituent.CONSTITUENT_WEIGHT_CHANGED, payload: { id: id, weight: weight } });
    },

    rebalance: function rebalance() {
      dispatch({ type: _actionTypes2.default.constituent.REBALANCE });
    },

    reset: function reset() {
      dispatch({ type: _actionTypes2.default.constituent.RESET });
    },

    delete: function _delete(id) {
      dispatch({ type: _actionTypes2.default.constituent.DELETE, payload: { id: id } });
    },

    toggleLock: function toggleLock(id, locked) {
      dispatch({ type: _actionTypes2.default.constituent.TOGGLE_LOCK, payload: { id: id, locked: locked } });
    }
  };
};
...
var listingActions = function listingActions(dispatch) {
  return {
    fetchListing: function fetchListing() {
      dispatch({ type: _actionTypes2.default.portfolio.PORTFOLIO_FETCH });
      ...
      _data2.default.map(function (portfolio) {
        ...
        listing.push({
          id: id, name: name, mean_return: mean_return, volatility: volatility, currency: currency
        });
        return portfolio;
      });
      dispatch({ type: _actionTypes2.default.portfolio.PORTFOLIO_FETCH_SUCCESS, payload: { listing: listing } });
    }
  };
};

exports.default = listingActions;
...
var _Listings = __webpack_require__(/*! ./containers/Listings */ "./src/components/containers/Listings.jsx");

var _Listings2 = _interopRequireDefault(_Listings);

var _Customize = __webpack_require__(/*! ./containers/Customize */ "./src/components/containers/Customize.jsx");
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/customize/:id', component: _Customize2.default })
        )
      );
    }
  }]);
...
/***/ "./src/components/containers/CategoryList.jsx":
/*!****************************************************!*\
  !*** ./src/components/containers/CategoryList.jsx ***!
  \****************************************************/
/*! no static exports found */
...
var _List = __webpack_require__(/*! ../core/List */ "./src/components/core/List.jsx");

var _List2 = _interopRequireDefault(_List);

var _Spinner = __webpack_require__(/*! ../core/Spinner */ "./src/components/core/Spinner.jsx");

var _Spinner2 = _interopRequireDefault(_Spinner);

var _createForm = __webpack_require__(/*! ../core/createForm */ "./src/components/core/createForm.jsx");
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('i', { className: 'icon ion-md-trash color-danger' })
        ),
        '\xA0',
        props.name
      )
  ...
  _createClass(CategoryList, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'category-title col-12 d-flex' },
          _react2.default.createElement(
            'div',
            { className: 'col-4' },
            _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: '#' },
              _react2.default.createElement('i', { className: 'icon ion-md-add' }),
              ' Add Bond'
            )
          ),
          _react2.default.createElement(
...
exports.default = (0, _createForm2.default)(CategoryList);

/***/ }),

/***/ "./src/components/containers/Customize.jsx":
/*!*************************************************!*\
  !*** ./src/components/containers/Customize.jsx ***!
  \*************************************************/
/*! no static exports found */
...
var _customizeActions = __webpack_require__(/*! ../../actions/customizeActions */ "./src/actions/customizeActions.js");

var _customizeActions2 = _interopRequireDefault(_customizeActions);

var _customizeSelector = __webpack_require__(/*! ../../selectors/customizeSelector */ "./src/selectors/customizeSelector.js");

var _customizeSelector2 = _interopRequireDefault(_customizeSelector);

var _List = __webpack_require__(/*! ../core/List */ "./src/components/core/List.jsx");

var _List2 = _interopRequireDefault(_List);

var _CategoryList = __webpack_require__(/*! ./CategoryList */ "./src/components/containers/CategoryList.jsx");

var _CategoryList2 = _interopRequireDefault(_CategoryList);

var _withLoader = __webpack_require__(/*! ../core/withLoader */ "./src/components/core/withLoader.jsx");
...
var Customize = function (_React$Component) {
  ...
  function Customize() {
    ...
    return _possibleConstructorReturn(this, (Customize.__proto__ || Object.getPrototypeOf(Customize)).apply(this, arguments));
  }
  ...
  _createClass(Customize, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'customize-title col-12' },
          _react2.default.createElement(
            'h1',
            null,
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'button button--primary medium', onClick: this.props.reset },
              'Reset'
            ),
            _react2.default.createElement(
              'button',
              { className: 'button button--primary medium', onClick: this.props.rebalance },
              'Rebalance'
            ),
            _react2.default.createElement(
              'button',
        ...
        _react2.default.createElement(
          'div',
          { className: 'customize-container col-12' },
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(_List2.default, {
            childComponent: _CategoryList2.default,
...
var mapStateToProps = function mapStateToProps(state, props) {
  return (0, _customizeSelector2.default)(state, props);
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return (0, _customizeActions2.default)(dispatch);
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _withLoader2.default)(Customize, 'fetching'));

/***/ }),

/***/ "./src/components/containers/Listings.jsx":
/*!************************************************!*\
  !*** ./src/components/containers/Listings.jsx ***!
  \************************************************/
/*! no static exports found */
...
var _listingActions = __webpack_require__(/*! ../../actions/listingActions */ "./src/actions/listingActions.js");

var _listingActions2 = _interopRequireDefault(_listingActions);

var _listingSelector = __webpack_require__(/*! ../../selectors/listingSelector */ "./src/selectors/listingSelector.js");

var _listingSelector2 = _interopRequireDefault(_listingSelector);
...
var _Bucket = __webpack_require__(/*! ../presenters/Bucket */ "./src/components/presenters/Bucket.jsx");
  ...
  _createClass(Listings, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'listing-title col-12' },
          _react2.default.createElement(
            'h2',
            { className: 'text-center' },
            'Here are few recommondation for you to choose from'
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'listing-container container d-flex' },
          _react2.default.createElement(_List2.default, {
            childComponent: _Bucket2.default,
...
var mapStateToProps = function mapStateToProps(state) {
  return (0, _listingSelector2.default)(state);
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return (0, _listingActions2.default)(dispatch);
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _withLoader2.default)(Listings, 'fetching'));

/***/ }),

/***/ "./src/components/core/List.jsx":
/*!**************************************!*\
  !*** ./src/components/core/List.jsx ***!
  \**************************************/
/*! no static exports found */
...
var List = function (_React$Component2) {
  ...
  _createClass(List, [{
    ...
    value: function renderChild(item) {
      ...
      return _react2.default.createElement(ChildComponent, _extends({}, item, this.props.childProps));
    }
  }, {
    key: 'renderChildren',
...
var _createFormInput = __webpack_require__(/*! ./createFormInput */ "./src/components/core/createFormInput.jsx");

var _createFormInput2 = _interopRequireDefault(_createFormInput);
...
var Spinner = function (_React$Component) {
  ...
  _createClass(Spinner, [{
    ...
    value: function increment() {
      if (this.props.max !== undefined && this.props.max === this.props.value) return;
      var step = this.props.step ? this.props.step : 0;
      var value = this.props.value + step;
      this.props.onChange(Math.round(value * 100) / 100);
    }
  }, {
    key: 'decrement',
    value: function decrement() {
      if (this.props.min !== undefined && this.props.min === this.props.value) return;
      var step = this.props.step ? this.props.step : 0;
      var value = this.props.value - step;
      this.props.onChange(Math.round(value * 100) / 100);
    }
    ...
    value: function render() {
      ...
      var disableInc = this.props.max !== undefined && this.props.max === this.props.value;
      var disableDec = this.props.min !== undefined && this.props.min === this.props.value;
      return _react2.default.createElement(
        'div',
        { className: 'spinner' },
        _react2.default.createElement(
          'div',
          { className: 'spinner-controls d-flex' },
          _react2.default.createElement(
            'span',
            { className: disableDec ? "rnd-btn disabled" : "rnd-btn", onClick: this.decrement.bind(this) },
            '-'
          ),
          _react2.default.createElement('input', {
            ...
            onChange: function onChange(e) {
              ...
              if (value == '') {
                _this2.props.onChange(0);
              }
              if (!isNaN(parseFloat(value))) {
                _this2.props.onChange(Math.round(value * 100) / 100);
              }
            }
          }),
          _react2.default.createElement(
            'span',
            { className: disableInc ? "rnd-btn disabled" : "rnd-btn", onClick: this.increment.bind(this) },
            '+'
          )
        )
      );
...
exports.default = (0, _createFormInput2.default)(Spinner);

/***/ }),

/***/ "./src/components/core/createForm.jsx":
/*!********************************************!*\
  !*** ./src/components/core/createForm.jsx ***!
  \********************************************/
/*! no static exports found */
...
var _createFormStore = __webpack_require__(/*! ../../utils/createFormStore */ "./src/utils/createFormStore.js");

var _createFormStore2 = _interopRequireDefault(_createFormStore);
...
function createFrom(FormComponent) {
  var Form = function (_React$Component) {
    ...
    function Form(props) {
      ...
      _this.valueStore = (0, _createFormStore2.default)(_this.props.data || {});
      _this.errorStore = (0, _createFormStore2.default)();
      _this.setUpStore();
      return _this;
    }
    ...
    _createClass(Form, [{
      ...
      key: 'willComponentUnMount',
      value: function willComponentUnMount() {
        this.clearSubscriptions();
        this.valueStore = null;
        this.errorStore = null;
      }
    }, {
      key: 'onValueStoreChange',
      value: function onValueStoreChange(type, payload) {
      ...
      key: 'onErrorStoreChange',
      value: function onErrorStoreChange(type, _ref) {
        var prop = _ref.prop,
            value = _ref.value;
      }
    }, {
      ...
      value: function handleSubmit() {
        var _getChildContext = this.getChildContext(),
            valueStore = _getChildContext.valueStore,
            errorStore = _getChildContext.errorStore;

        valueStore.trigger('forceValidate');
        var errors = errorStore.getAll();
        if (Object.keys(errors).length === 0) {
          var data = valueStore.getAll();
  ...
  Form.childContextTypes = {
    valueStore: _propTypes2.default.object,
    errorStore: _propTypes2.default.object
  };
...
/***/ "./src/components/core/createFormInput.jsx":
/*!*************************************************!*\
  !*** ./src/components/core/createFormInput.jsx ***!
  \*************************************************/
/*! no static exports found */
...
exports.default = createFromInput;
...
var _createValidator = __webpack_require__(/*! ../../utils/createValidator */ "./src/utils/createValidator.js");
...
function createFromInput(InputComponent) {
  var FormInput = function (_React$Component) {
    ...
    function FormInput(props) {
      ...
      _this._valueStoreSubscriber = _this.onValueStoreChange.bind(_this);
      _this._errorStoreSubscriber = _this.onErrorStoreChange.bind(_this);
      _this.state = {
        isPristine: true,
        hasError: false,
        errorMessage: ''
    ...
    _createClass(FormInput, [{
      key: 'componentWillMount',
      value: function componentWillMount() {
        this.setState(_extends({}, this.state, { value: this.props.value }));
      ...
      value: function componentWillReceiveProps(newProps) {
        if (newProps.value !== undefined && newProps.value !== this.state.value) {
          this.setState(_extends({}, this.state, { value: newProps.value }));
      ...
      value: function setUpValidations() {
        if (!this._validations && this._validations !== this.props.validations) {
          ...
          this.validator = (0, _createValidator2.default)(this._validations);
          this.setUpSiblingValidationIndex();
        }
      }
    }, {
      key: 'setUpSiblingValidationIndex',
      value: function setUpSiblingValidationIndex() {
        var self = this;
        this._dependentSiblings = this.props.validations.reduce(function (result, item) {
      ...
      value: function getPropsForChild() {
        ...
        Object.keys(this.props).map(function (prop) {
          if (prop !== 'validations') {
            newProps[prop] = _this2.props[prop];
          }
          return null;
        });
        return _extends({}, newProps, {
          hasError: hasError, errorMessage: errorMessage, value: value,
      ...
      value: function render() {
        ...
        var childProps = this.getPropsForChild();
        return _react2.default.createElement(
          InputComponent,
          childProps,
          this.props.children
      ...
      key: 'runValidator',
      value: function runValidator(name, value) {
        ...
        if (name === this.props.name) {
          ...
          return this.validator(this.context.valueStore.get(this.props.name), { name: name, value: value });
        }
      }
    }, {
      key: 'forceValidate',
      value: function forceValidate() {
        var error = this.runValidator(this.props.name, this.context.valueStore.get(this.props.name));
        var siblings = this._dependentSiblings;
...
/***/ "./src/components/core/withLoader.jsx":
/*!********************************************!*\
  !*** ./src/components/core/withLoader.jsx ***!
  \********************************************/
/*! no static exports found */
...
function withLoader(Component, loadingFlag) {
  return function (props) {
    if (props[loadingFlag] === true) {
      return _react2.default.createElement("div", { className: "spinner-loader" });
    } else {
...
/***/ "./src/components/presenters/Bucket.jsx":
/*!**********************************************!*\
  !*** ./src/components/presenters/Bucket.jsx ***!
  \**********************************************/
/*! no static exports found */
...
var Head = function (_React$Component) {
  ...
  _createClass(Head, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'portfolio-wrap col-12' },
        _react2.default.createElement(
          'div',
          { className: 'banner col-12' },
          _react2.default.createElement(
            'div',
            { className: 'detail-bar row m-0' },
            _react2.default.createElement(
              'div',
              { className: 'duration col-12' },
              this.props.name
            )
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'portfolio-details col-12' },
          _react2.default.createElement(
            'div',
            { className: 'data-row row' },
            _react2.default.createElement(
              'div',
              { className: 'col-6 data-title' },
              'Volatility'
            ),
            _react2.default.createElement(
              'div',
              { className: 'col-6 data-value' },
              this.props.volatility
            )
          ),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactRouterDom.Link,
                { className: 'button medium button--secondary col-12', to: '/customize/' + this.props.id },
...
reducers[_actionTypes2.default.constituent.CONSTITUENT_FETCH] = function (state) {
  return _extends({}, state, {
    fetching: true
  });
};

reducers[_actionTypes2.default.constituent.CONSTITUENT_FETCH_SUCCESS] = function (state, _ref) {
  var bucketList = _ref.bucketList,
...
reducers[_actionTypes2.default.constituent.CONSTITUENT_WEIGHT_CHANGED] = function (state, _ref2) {
  var id = _ref2.id,
      weight = _ref2.weight;

  var bucketList = [];
  state.bucketList.map(function (item) {
    var newItem = item;
    if (item.id === id) {
...
reducers[_actionTypes2.default.constituent.REBALANCE] = function (state) {
  var toChange = [];var locked = [];
  var toBalance = [];
  var changeSum = 0;var lockedSum = 0;var toBalanceSum = 0;var balance = 100;
  state.bucketList.map(function (item) {
  ...
  changeSum = toChange.reduce(function (acc, item) {
    return acc + item.editWeight;
  }, changeSum);

  lockedSum = locked.reduce(function (acc, item) {
    return acc + item.editWeight;
  }, lockedSum);

  toBalanceSum = toBalance.reduce(function (acc, item) {
    return acc + item.editWeight;
  }, toBalanceSum);

  balance -= lockedSum + changeSum;

  toBalance = toBalance.map(function (item) {
    return _extends({}, item, {
      editWeight: Math.round(item.editWeight / toBalanceSum * 100 * balance) / 100
    });
  });
  return _extends({}, state, {
    bucketList: toChange.concat(locked).concat(toBalance).sort(function (c, n) {
      return c.id - n.id;
    })
  });
};

reducers[_actionTypes2.default.constituent.RESET] = function (state) {
  var bucketList = [];
  state.bucketList.map(function (item) {
    bucketList.push(_extends({}, item, {
...
reducers[_actionTypes2.default.constituent.DELETE] = function (state, _ref3) {
  var id = _ref3.id;
...
reducers[_actionTypes2.default.constituent.TOGGLE_LOCK] = function (state, _ref4) {
  var id = _ref4.id,
      locked = _ref4.locked;
...
var _portfolio = __webpack_require__(/*! ./portfolio */ "./src/reducers/portfolio.js");

var _portfolio2 = _interopRequireDefault(_portfolio);

var _constituent = __webpack_require__(/*! ./constituent */ "./src/reducers/constituent.js");
...
reducers[_actionTypes2.default.portfolio.PORTFOLIO_FETCH] = function (state) {
  return _extends({}, state, {
    fetching: true
  });
};

reducers[_actionTypes2.default.portfolio.PORTFOLIO_FETCH_SUCCESS] = function (state, _ref) {
...
/***/ "./src/selectors/customizeSelector.js":
/*!********************************************!*\
  !*** ./src/selectors/customizeSelector.js ***!
  \********************************************/
/*! no static exports found */
...
var customizeSelector = function customizeSelector(state) {
  var _state$constituent = state.constituent,
      fetching = _state$constituent.fetching,
      bucketList = _state$constituent.bucketList,
      categories = _state$constituent.categories;
  ...
  if (categories) {
    categories.map(function (cat) {
      var list = [];
      var totalWeight = 0;
      var totalEditWeight = 0;
      bucketList.reduce(function (acc, item) {
        if (item.type === cat) {
      ...
      categoryList.push({
        type: cat, list: list, totalWeight: totalWeight, totalEditWeight: totalEditWeight
      });
      return null;
    });
  }
  return { fetching: fetching, categoryList: categoryList };
};

exports.default = customizeSelector;

/***/ }),

/***/ "./src/selectors/listingSelector.js":
/*!******************************************!*\
  !*** ./src/selectors/listingSelector.js ***!
  \******************************************/
/*! no static exports found */
...
var listingSelector = function listingSelector(state) {
  var _state$portfolio = state.portfolio,
      fetching = _state$portfolio.fetching,
      listing = _state$portfolio.listing;

  return { fetching: fetching, listing: listing };
};

exports.default = listingSelector;

/***/ }),

/***/ "./src/utils/createFormStore.js":
/*!**************************************!*\
  !*** ./src/utils/createFormStore.js ***!
  \**************************************/
/*! no static exports found */
...
function createFormStore() {
  ...
  var getAll = function getAll() {
    var toReturn = {};
    Object.keys(dataMap).map(function (prop) {
  ...
  var set = function set(prop, value) {
    ...
    dataMap[prop] = value;
    if (!silent) {
      trigger('change', { prop: prop, value: value });
    }
  };

  var unSet = function unSet(prop) {
    var newDataMap = [];
  ...
  var setAll = function setAll(map) {
    dataMap = {};
    Object.keys.map(function (prop) {
...
var _validatorUtils = __webpack_require__(/*! ./validatorUtils */ "./src/utils/validatorUtils.js");

function createValidator() {
  var validations = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

  var selfValidationRules = validations.filter(function (item) {
    return item.element === undefined;
  }).map(function (rule) {
    return (0, _validatorUtils.getValidationRule)(rule);
  });
  var siblingValidationRules = validations.filter(function (item) {
    return item.element !== undefined;
  }).map(function (rule) {
    return (0, _validatorUtils.getValidationRule)(rule);
  });

  var selfValidator = (0, _validatorUtils.getSelfValidator)(selfValidationRules);
  var siblingValidator = (0, _validatorUtils.getSiblingValidator)(siblingValidationRules);

  return function (value, sibling) {
    if (sibling) {
...
var validatorMap = {
  ...
  email: function email(rule, value) {
    ...
    var ckEmail = /^[_A-Za-z0-9-\+]+(\.[_A-Za-z0-9-\\+]+)*@[_A-Za-z0-9-\+]+(\.[_A-Za-z0-9-\+]+)*(\.[A-Za-z]{2,})$/i;
  ...
  url: function url(rule, value) {
    ...
    var ckUrl = /(http|https|market):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/i;
...
var exprMessageMap = function exprMessageMap(expr, val) {
  var expression = expr.toLowerCase().trim();
  switch (expression) {
    case 'req':
    case 'required':
...
exports.validatorMap = validatorMap;
exports.exprMessageMap = exprMessageMap;
...
exports.getSiblingValidator = exports.getSelfValidator = exports.getValidationRule = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _validatorMap = __webpack_require__(/*! ./validatorMap */ "./src/utils/validatorMap.js");

var getValidationRule = exports.getValidationRule = function getValidationRule(item) {
  var expressionMap = (0, _validatorMap.exprMessageMap)(item.expr, item.value || item.element);
  return {
    expr: expressionMap.expr,
    value: item.value,
    element: item.element,
    func: expressionMap.expr === 'function' ? item.func : _validatorMap.validatorMap[expressionMap.expr],
    message: item.message || expressionMap.message
  };
};

var getSelfValidator = exports.getSelfValidator = function getSelfValidator(validations) {
  return function (value) {
    var errors = [];
    validations.map(function (item) {
      if (!item.func.call(undefined, item, value)) errors.push(item.message);
      return null;
    });
    return errors;
  };
...
var getSiblingValidator = exports.getSiblingValidator = function getSiblingValidator(validations) {
  return function (value, sibling) {
    var errors = [];
    validations.filter(function (item) {
      return item.element === sibling.name;
    }).map(function (item) {
      var newItem = _extends({}, item, { value: sibling.value });
      if (!newItem.func.call(undefined, newItem, value)) errors.push(newItem.message);
      return null;
    });
    return errors;
  };
...
/***/ 0:
/*!********************************************!*\
  !*** multi ./src/main.js ./scss/main.scss ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
